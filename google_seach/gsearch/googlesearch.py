...
def download(query, num_results):
    ...
    """
    # https://stackoverflow.com/questions/11818362/how-to-deal-with-unicode-string-in-url-in-python2.7
    name = quote(query)
...
def search(query, num_results=10):
    ...
    for r in results:
        ...
        #mtch_summa = re.match(r'.*?\<div\ class=\"r\".*?\>(.*?)\</div\>.*$', r, flags=re.IGNORECASE)
        #print(mtch_summa.group(0))
        if mtch is None:
            continue
        #print(r)
        # parse url
