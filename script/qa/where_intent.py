...
statements = [
    "where can I find |{}",
    "tell me the website of |{}",
    "tell me where I can find |{}",
    "where can I get information about |{}",
    "tell me where I can get information about |{}"
]
...
intent = {
    "name": "Query Where To Find Intent",
    "auto": True,
    "contexts": [],
    "responses": [
        {
...
def generate_intent():
    ...
    with open("intent/queryWhereToFindIntent.json", "w") as json_file:
