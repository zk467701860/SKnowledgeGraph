...
def import_all_jdk_package():
    jdk_package_knowledge_table = KnowledgeTableFactory.find_knowledge_table_by_name(session, "jdk_package")
    ...
    cur.execute("select * from jdk_package")
