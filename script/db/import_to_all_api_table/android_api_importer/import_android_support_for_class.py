...
logger = Logger("import_android_support_class").get_log()
IMPORT_DATA_SOURCE_TABLE_NAME = "androidAPI_support_class"
package_knowledge_table = KnowledgeTableFactory.find_knowledge_table_by_name(session=session,
                                                                             name="androidAPI_support_package")
...
def create_class_node(row_data):
    ...
    logger.info("qualified_name=%s type=%s form %s", qualified_name, api_type, full_declaration)
