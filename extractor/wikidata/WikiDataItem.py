...
class WikiDataItem:
    ...
    def init_wikidata_item_from_wikipedia_url(self, wikipedia_url):
        try:
            ...
            # example json {"batchcomplete":"","query":{"pages":{"15881":{"pageid":15881,"ns":0,"title":"Java (programming language)","pageprops":{"wikibase_item":"Q251"}}}}}
    ...
    def parse_illegal_json_string(data_json_string):
        ...
        try:
            try:
                ...
                data_json_string = json.dumps(eval(data_json_string), encoding='utf-8')
