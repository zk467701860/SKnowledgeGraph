...
graphClient = DefaultGraphAccessor(GraphClient(server_number=5))


class JavaMethodAliasPropertyIncludeClassNameCreateOperation(GraphOperation):
    name = 'JavaMethodAliasPropertyIncludeClassNameCreateOperation'
    ...
    def operate(self, node):
        ...
        if node['name']:
            ...
            class_node = graphClient.get_class_node_for_method_node(method_node_id)
